...
ax.text(0.09, 1.02, f"Stock symbol: '{stock_name}'", transform=ax.transAxes, color="green", ha='right', fontsize=12)
...
def close_window():
    st.button('Close', on_click=st.stop)
